...
----------
 ...
 - (Added) A ``sismic.clock`` module with a ``BaseClock`` base class and two direct implementations, 
   namely ``SimulatedClock`` and ``WallClock``. A ``SimulatedClock`` allows to manually or automatically 
